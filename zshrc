...
alias gipo='git pull origin `git rev-parse --abbrev-ref HEAD`'
...
if [ -f '/Users/takahashiseiji/Downloads/google-cloud-sdk/path.zsh.inc' ]; then source '/Users/takahashiseiji/Downloads/google-cloud-sdk/path.zsh.inc'; fi
